proc create_ipi_design { offsetfile design_name } {
	...
	set offset_file "${bd_path}/PWM_w_Int_v1_1_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef PWM_w_Int_v1_1_tb_include_vh_"
	puts $fp "`define PWM_w_Int_v1_1_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:PWM_w_Int:1.1]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/PWM_w_Int_v1_1_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "PWM_w_Int_v1_1_bfm_${i}"
...
remove_files -quiet -fileset sim_1 PWM_w_Int_v1_1_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top PWM_w_Int_v1_1_tb [get_filesets sim_1]
